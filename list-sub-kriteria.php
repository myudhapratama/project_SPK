...
if (isset($_POST['tambah'])) :
	...
	if (empty($errors)) :
		$simpan = mysqli_query($koneksi, "INSERT INTO sub_kriteria (id_sub_kriteria, id_kriteria, sub_kriteria, nilai) VALUES ('', '$id_kriteria', '$nama', '$nilai')");
...
if (isset($_POST['edit'])) :
	...
	if (empty($errors)) :
		$update = mysqli_query($koneksi, "UPDATE sub_kriteria SET sub_kriteria = '$nama', nilai = '$nilai' WHERE id_kriteria = '$id_kriteria' AND id_sub_kriteria = '$id_sub_kriteria'");
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> Tambah <?= $data['kriteria'] ?></h5>
										...
										<div class="modal-content">
											...
											<form action="list-sub-kriteria.php?id=<?php echo $d['id_sub_kriteria']; ?>" method="post">
												...
												<div class="modal-body">
													...
													<div class="form-group">
														<label class="font-weight-bold">Nilai</label>
														<input type="number" autocomplete="off" name="nilai" class="form-control" value="<?= $d['nilai'] ?>" required>
													</div>
												</div>
												<div class="modal-footer">
													<button type="button" class="btn btn-warning" data-dismiss="modal"><i class="fa fa-times"></i> Batal</button>
