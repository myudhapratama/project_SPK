...
if (isset($_POST['submit'])) :
	...
	if (empty($errors)) :
		$simpan = mysqli_query($koneksi, "INSERT INTO `alternatif` (`id_alternatif`, `alternatif`, `nama`) VALUES (NULL, '$alternatif', '$nama')");
		if ($simpan) {
		...
		<div class="card-body">
			<div class="row">
				...
				<div class="form-group col-md-6">
					...
					<input autocomplete="off" type="text" name="alternatif" required value="" class="form-control" />
				</div>
				<div class="form-group col-md-6">
