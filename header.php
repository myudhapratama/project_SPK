    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php" style="background-color: white;">
        <div class="sidebar-brand-icon rotate-n-15">
          <img src="assets/img/Lambang_Kabupaten_Siak.png" width="30" height="30">
        </div>
        <div class="sidebar-brand-text mx-3" style="color: black; font-size: 11px;">SPK Desa Tualang</div>
      </a>
      ...
      if ($user_role == 'RT') {
      ?>
        <li class="nav-item <?php if ($page == "Warga") {
                              echo "active";
                            } ?>">
          <a class="nav-link" href="list-warga.php">
            <i class="fas fa-fw fa-users"></i>
            <span>Input Data Warga</span></a>
        </li>
      <?php } if ($user_role == 'RW') { ?>
        <li class="nav-item <?php if ($page == "Warga") {
                              echo "active";
          ...
          <a class="nav-link" href="list-warga.php">
            <i class="fas fa-fw fa-users"></i>
            <span>Validasi Data Warga</span></a>
        </li>
