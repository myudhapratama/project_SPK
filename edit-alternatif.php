...
if (isset($_POST['submit'])) :
	...
	if (empty($errors)) :
		...
		$update = mysqli_query($koneksi, "UPDATE alternatif SET alternatif = '$alternatif', nama = '$nama' WHERE id_alternatif = '$id_alternatif'");
		if ($update) {
						...
						<div class="card-body">
							<div class="row">
								<div class="form-group col-md-6">
									...
									<input autocomplete="off" type="text" name="alternatif" required value="<?php echo $d['alternatif']; ?>" class="form-control" />
								</div>
								<div class="form-group col-md-6">
