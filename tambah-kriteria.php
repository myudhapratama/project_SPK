...
if (isset($_POST['submit'])) :
	...
	if (empty($errors)) :
		...
		$simpan = mysqli_query($koneksi, "INSERT INTO kriteria (id_kriteria, kode_kriteria, kriteria, type, bobot, ada_pilihan) VALUES ('', '$kode_kriteria', '$nama', '$type', '$bobot', '$ada_pilihan')");
		if ($simpan) {
