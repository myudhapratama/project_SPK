			...
			<div class="row align-items-center">
				<div class="col-md-5 offset-2">
					<div class="card-body">
						...
						<h4 class="mb-3 f-w-400">Registrasi Account</h4>
						...
						<button class="btn btn-primary mb-4">Daftar</button>
						<p class="mb-2">Sudah punya account? <a href="signin.php" class="f-w-400">Log in</a></p>
					</div>
				</div>
